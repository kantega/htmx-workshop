...
public class ProductRepository {
    ...
    public ProductRepository() {
        ...
        products.add(createProduct("Goodfellas (1990) Blu-ray", "Goodfellas is a 1990 American biographical crime film directed by Martin Scorsese, written by Nicholas Pileggi and Scorsese, and produced by Irwin Winkler. It is a film adaptation of the 1985 nonfiction book Wiseguy by Pileggi.", "390.00", "https://upload.wikimedia.org/wikipedia/en/7/7b/Goodfellas.jpg"));
        products.add(createProduct("Memento (2000) Blu-ray", "Memento is a 2000 American neo-noir psychological thriller film written and directed by Christopher Nolan, based on the short story Memento Mori by his brother Jonathan Nolan, which was later published in 2001.", "99.00", "https://upload.wikimedia.org/wikipedia/en/c/c7/Memento_poster.jpg"));
        ...
        products.add(createProduct("Erin Brockovich (2000) Blu-ray", "Erin Brockovich is a 2000 American biographical legal drama film directed by Steven Soderbergh and written by Susannah Grant. The film is a dramatization of the true story of Erin Brockovich, portrayed by Julia Roberts.", "189.99", "https://upload.wikimedia.org/wikipedia/en/a/a9/Erin_Brockovich_%28film_poster%29.jpg"));
        ...
        products.add(createProduct("The Departed (2006) Blu-ray", "The Departed is a 2006 American epic crime thriller film directed by Martin Scorsese and written by William Monahan. It is both a remake of the 2002 Hong Kong film Infernal Affairs and also loosely based on the real-life Boston Winter Hill Gang.", "129.99", "https://upload.wikimedia.org/wikipedia/en/5/50/Departed234.jpg"));
        products.add(createProduct("Avatar (2009) Blu-ray", "Avatar is a 2009 epic science fiction film directed, written, co-produced, and co-edited by James Cameron and starring Sam Worthington, Zoe Saldana, Stephen Lang, Michelle Rodriguez, and Sigourney Weaver. It is the first installment in the Avatar film series.", "269.49", "https://upload.wikimedia.org/wikipedia/en/d/d6/Avatar_%282009_film%29_poster.jpg"));
