            ...
            _products = new List<Product>
                {
                    ...
                    new Product { ID = 11, Name = "Goodfellas (1990) Blu-ray", Description = "Goodfellas is a 1990 American biographical crime film directed by Martin Scorsese, written by Nicholas Pileggi and Scorsese, and produced by Irwin Winkler. It is a film adaptation of the 1985 nonfiction book Wiseguy by Pileggi.", Price = 390.00m, Image = "https://upload.wikimedia.org/wikipedia/en/7/7b/Goodfellas.jpg" },
                    new Product { ID = 12, Name = "Memento (2000) Blu-ray", Description = "Memento is a 2000 American neo-noir psychological thriller film written and directed by Christopher Nolan, based on the short story Memento Mori by his brother Jonathan Nolan, which was later published in 2001.", Price = 99.00m, Image = "https://upload.wikimedia.org/wikipedia/en/c/c7/Memento_poster.jpg" },
                    ...
                    new Product { ID = 14, Name = "Erin Brockovich (2000) Blu-ray", Description= "Erin Brockovich is a 2000 American biographical legal drama film directed by Steven Soderbergh and written by Susannah Grant. The film is a dramatization of the true story of Erin Brockovich.", Price = 189.99m, Image = "https://upload.wikimedia.org/wikipedia/en/a/a9/Erin_Brockovich_%28film_poster%29.jpg" },
                    ...
                    new Product { ID = 18, Name = "The Departed (2006) Blu-ray", Description = "The Departed is a 2006 American epic crime thriller film directed by Martin Scorsese and written by William Monahan. It is both a remake of the 2002 Hong Kong film Infernal Affairs and also loosely based on the real-life Boston Winter Hill Gang.", Price = 129.99m, Image = "https://upload.wikimedia.org/wikipedia/en/5/50/Departed234.jpg" },
                    new Product { ID = 19, Name = "Avatar (2009) Blu-ray", Description = "Avatar is a 2009 epic science fiction film directed, written, co-produced, and co-edited by James Cameron and starring Sam Worthington, Zoe Saldana, Stephen Lang, Michelle Rodriguez, and Sigourney Weaver. It is the first installment in the Avatar film series.", Price = 269.49m, Image = "https://upload.wikimedia.org/wikipedia/en/d/d6/Avatar_%282009_film%29_poster.jpg" },
